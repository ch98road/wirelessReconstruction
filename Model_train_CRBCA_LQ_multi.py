...
import config.config_CRBCA_LQ as cfg
from tensorboardX import SummaryWriter
import utils.CosineAnnealingWithWarmup as LR
from model.Model_define_pytorch_CRBCA_LQ import AutoEncoder, DatasetFolder, NMSE
...
for epoch in range(cfg.epochs):
    ...
    print('GPU:{}\tscore={}'.format(dist.get_rank(),1-test_loss))
    print('GPU:{}\ttestMSE={}'.format(dist.get_rank(), test_loss))
    if dist.get_rank() == 0:
        # 画图
