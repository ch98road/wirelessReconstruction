...
class Encoder(nn.Module):
    ...
    def __init__(self, feedback_bits):
        ...
        self.res3 = ResBlockWithCBAM(64, 64)
        self.conv4 = conv1x1(64, 32)
        self.res4 = ResBlockWithCBAM(32, 32)
        self.conv5 = conv1x1(32, 2)
    ...
    def forward(self, x):
        ...
        out = F.relu(self.conv3(res))
        res = self.res3(out) + out
        out = F.relu(self.conv4(res))
        res = self.res4(out) + out
        out = F.relu(self.conv5(out)) + x
...
class Decoder(nn.Module):
    ...
    def __init__(self, feedback_bits):
        ...
        self.after_conv = conv1x1(in_planes=self.layers[-1][1], out_planes=2)
