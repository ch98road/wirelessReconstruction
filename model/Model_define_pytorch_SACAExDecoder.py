    ...
    def __init__(self, feedback_bits):
        ...
        for _ in range(3):
            self.multiConvs.append(
                nn.Sequential(conv3x3(2, 16), nn.ReLU(), conv3x3(16, 32),
                              nn.ReLU(), conv3x3(32, 2), nn.ReLU()))
