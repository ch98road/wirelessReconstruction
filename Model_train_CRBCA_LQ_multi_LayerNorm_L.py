...
import config.config_CRBCA_LQ_LayerNorm_L as cfg
from tensorboardX import SummaryWriter
import utils.CosineAnnealingWithWarmup as LR
from model.Model_define_pytorch_CRBCA_LQ_LayerNorm_L import AutoEncoder, DatasetFolder, NMSE
...
for epoch in range(cfg.epochs):
    ...
    if cfg.L2LOSS:
        ...
        l2_ave_loss = 0
    print('[{}/{}]\tLOSS:{:.6f}\tL2_LOSS:{:.6f}\tLR:{:.6f}\t'.format(
        epoch, cfg.epochs, ave_loss - l2_ave_loss, l2_ave_loss,
        cosineLR.get_lr()))
    # model evaluating
