...
MODEL_SAVE_PATH = 'Modelsave/SelfAtt'
LOG_PATH = 'SelfAtt'
LAMDA = 0.2
...
#                                 'decoder.pth.tar')
PRE_ENCODER_PATH = os.path.join(PROJECT_ROOT, 'Modelsave/SelfAtt',
                                'encoder.pth.tar')
PRE_DECODER_PATH = os.path.join(PROJECT_ROOT, 'Modelsave/SelfAtt',
                                'decoder.pth.tar')
resnet_model_urls = {
