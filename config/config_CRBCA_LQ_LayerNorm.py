...
MODEL_SAVE_PATH = 'Modelsave/CRBCAv1LQLayerNormv1'
LOG_PATH = 'CRBCAv1LQLayerNormv1'

# PRE_ENCODER_PATH = os.path.join(PROJECT_ROOT, MODEL_SAVE_PATH,
#                                 'encoder.pth.tar')
# PRE_DECODER_PATH = os.path.join(PROJECT_ROOT, MODEL_SAVE_PATH,
#                                 'decoder.pth.tar')
PRE_ENCODER_PATH = os.path.join(PROJECT_ROOT, 'Modelsave/CRBCAv1LQLayerNormv1',
                                'encoder.pth.tar')
PRE_DECODER_PATH = os.path.join(PROJECT_ROOT, 'Modelsave/CRBCAv1LQLayerNormv1',
                                'decoder.pth.tar')
