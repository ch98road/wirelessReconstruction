...
MODEL_SAVE_PATH = 'Modelsave/CRBv1TQDWv2'
LOG_PATH = 'CRBv1TQDWv2'
...
PRE_ENCODER_PATH = os.path.join(PROJECT_ROOT, 'Modelsave/SACACRBv1BQ',
                                'encoder.pth.tar')
PRE_DECODER_PATH = os.path.join(PROJECT_ROOT, 'Modelsave/SACACRBv1BQ',
                                'decoder.pth.tar')
