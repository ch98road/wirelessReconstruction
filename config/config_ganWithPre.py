...
MODEL_SAVE_PATH = 'Modelsave_GanWithPre'
LOG_PATH = 'GanWithPre'
LAMDA = 0.2
...
#                                 'decoder.pth.tar')
PRE_ENCODER_PATH = os.path.join(PROJECT_ROOT, 'Modelsave_baseline',
                                'encoder.pth.tar')
PRE_DECODER_PATH = os.path.join(PROJECT_ROOT, 'Modelsave_baseline',
                                'decoder.pth.tar')
resnet_model_urls = {
